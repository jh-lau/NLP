...
![Seq2Seq](../imgs_readme/Seq2Seq.png)
...
![Image-captioning](../imgs_readme/Image-captioning.png)
...
鉴于贪心搜索算法得到的结果显然难以符合上述要求，解决此问题最常使用的算法是**集束搜索（Beam Search）**。
...
![Beam-search](../imgs_readme/Beam-search.png)
...
![Error-analysis-process](../imgs_readme/Error-analysis-process.png)
...
![Attention-Model](../imgs_readme/Attention-Model.png)
...
![Computing-attention](../imgs_readme/Computing-attention.png)
...
![Attention-model-for-speech-recognition](../imgs_readme/Attention-model-for-speech-recognition.png)
...
![CTC-for-speech-recognition](../imgs_readme/CTC-for-speech-recognition.png)
...
![Trigger-word-detection-algorithm](../imgs_readme/Trigger-word-detection-algorithm.png)
