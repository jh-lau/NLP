...
![sigmoid-function](../imgs/sigmoid-function.png)

Logistic 回归可以看作是一个非常小的神经网络。下图是一个典型例子：

![LogReg_kiank](../imgs/LogReg_kiank.png)
...
![cost-function](../imgs/cost-function.png)
...
## 4.Logistic 回归中的梯度下降法

假设输入的特征向量维度为 2，即输入参数共有 x1, w1, x2, w2, b 这五个。可以推导出如下的计算图：

![Logistic-Computation-Graph](../imgs/Logistic-Computation-Graph.png)
...
![whole-logistic-training](../imgs/whole-logistic-training-update.png)
